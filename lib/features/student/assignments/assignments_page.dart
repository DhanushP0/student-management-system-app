...
class AssignmentsStudentPage extends StatefulWidget {
  const AssignmentsStudentPage({super.key});

  @override
  State<AssignmentsStudentPage> createState() => _AssignmentsPageState();
}

class _AssignmentsPageState extends State<AssignmentsStudentPage>
 ...
 Future<void> _loadAssignments() async {
  ...
  try {
    ...
    final response = await Supabase.instance.client
        ...
        ''')
        .eq('class_id', studentResponse['class_id'])
        .order('due_date');
